  ...
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[90%] relative font-poppins",
  {
    variants: {
      variant: {
        ...
        primary:
          "overflow-hidden border z-10 border-primary text-white bg-gradient-to-b from-primary to-primary/80 before:absolute before:inset-0 before:-z-10 before:translate-y-[200%] before:scale-[200%] before:rounded-[100%] before:bg-background before:transition-all before:duration-300 before:content-[''] hover:text-primary hover:before:translate-y-[0%]",
      },
      size: {
